document.addEventListener('DOMContentLoaded', function () {
  ...
  function applyScrollAnimations() {
    const elements = document.querySelectorAll(
      '.fade-in, .scroll-animate, [data-animate], .feature-card, .section-content, .hero-content'
    );
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'dcbbafca-b9bc-4aa9-9720-3e3f6b2015a8',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'dcbbafca-b9bc-4aa9-9720-3e3f6b2015a8';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'dcbbafca-b9bc-4aa9-9720-3e3f6b2015a8';
